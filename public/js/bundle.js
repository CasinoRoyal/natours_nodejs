...
var showAlert = function showAlert(type, message) {
  var alertMarkup = "<div class=\"alert alert--".concat(type, "\">").concat(message, "</div>");
      ...
      switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'You are log in');
...
var getLogOut = function getLogOut() {
  var res;
  return regeneratorRuntime.async(function getLogOut$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'You are log out');
        ...
        case 8:
          ...
          (0, _alerts.showAlert)('error', 'Something bad happened. Please, try again');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"update-user-settings.js":[function(require,module,exports) {
"use strict";
...
var updateUserSettings = function updateUserSettings(data, type) {
  ...
  return regeneratorRuntime.async(function updateUserSettings$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          endPoint = type === 'password' ? 'update-password' : 'change-user-data';
          _context.prev = 1;
          _context.next = 4;
          return regeneratorRuntime.awrap((0, _axios.default)({
            method: 'PATCH',
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "Your ".concat(type.toUpperCase(), " successfully updated"));
          }
...
var bookTour = function bookTour(tourId) {
  ...
  return regeneratorRuntime.async(function bookTour$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_aCysFaE4TPSgOWvqNDa25ORN00AAnSaNRV');
          _context.prev = 1;
          _context.next = 4;
          return regeneratorRuntime.awrap((0, _axios.default)("http://127.0.0.1:3000/api/v1/booking/checkout-session/".concat(tourId)));
...
var _updateUserSettings = require("./update-user-settings");
...
var tourBtn = document.getElementById('book-tour');
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    (0, _login.getLogIn)(email, password);
  });
}
...
if (logOutBtn) {
  logOutBtn.addEventListener('click', _login.getLogOut);
}
...
if (changePasswordForm) {
  changePasswordForm.addEventListener('submit', function _callee(e) {
    var savePassBtn, currentPassword, password, passwordConfirm;
    return regeneratorRuntime.async(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            savePassBtn = changePasswordForm.querySelector('.btn');
            savePassBtn.textContent = '...updating';
            currentPassword = document.getElementById('password-current').value;
            password = document.getElementById('password').value;
            passwordConfirm = document.getElementById('password-confirm').value;
            _context.next = 8;
            return regeneratorRuntime.awrap((0, _updateUserSettings.updateUserSettings)({
